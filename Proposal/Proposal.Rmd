...
A higher-level goal is to create pieces of "generative" art, ie., pieces of art that have been generated using computer input and mathematical formulas. 

You can find more details on data frame below and all the codes are included on "app.R" file in Shiny App folder.
