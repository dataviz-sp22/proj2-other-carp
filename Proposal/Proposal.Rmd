...
For the first question, important ... Count the time controlled by each party and visually represent it
		○ perhaps as alpha or a scale that goes from one color to the next
While the map is not necessary to answer this question, a bar chart ..
