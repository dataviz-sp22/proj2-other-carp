...
# we we further generalize by looping over the variable: 
# INCORRECT CODE. WHAT I WANT TO DO IS TO MAKE SURE AT LEAST ONE OF THE VARIABLES IN THE LIST IS 1. 
#for(i in 1:length(event_selected)) {
#  mydata_line_plot <- mydata_line_plot %>% subset(get(event_selected[i])==1)
#}
# GOOD CODE HERE:
