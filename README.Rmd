...
What we want to do is to use shiny app to live demonstrate the process of Russia-Ukraine war, including the territory movement, military and non-military events across different time frame. You can find more details on data frame below and all the codes are included on "app.R" file in Shiny App folder.
