...
Same patterns apply to coastal cities such as Odess, Mykolaiv, and Kherson. Usually, coastal cities are important for military operation because not only country can launch attack from sea, but also country can get reinforcement from shipment. Therefore, it is very important for country to conquer the coastal cities. 
